...
S {}
E {}
N 330 220 330 240 {lab=VGND}
N 290 130 290 190 {lab=#net1}
N -180 300 210 300 {lab=VGND}
N 210 270 210 300 {lab=VGND}
N 80 270 80 300 {lab=VGND}
N -50 270 -50 300 {lab=VGND}
N -50 180 -50 210 {lab=#net1}
N 80 180 80 210 {lab=#net1}
N 210 180 210 210 {lab=#net1}
N -180 180 210 180 {lab=#net1}
N 20 300 20 320 {lab=VGND}
N -40 -100 90 -100 {lab=VPWR}
N -40 -40 90 -40 {lab=#net2}
N 20 -40 20 -20 {lab=#net2}
N 20 160 20 180 {lab=#net1}
N 20 -120 20 -100 {lab=VPWR}
N 330 160 430 160 {lab=X}
N 20 160 290 160 {lab=#net1}
C {sky130_fd_pr/nfet_01v8.sym} 310 190 2 1 {name=M4
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
...
C {sky130_fd_pr/pfet_01v8_hvt.sym} 310 130 2 1 {name=M6
W=1e+06u
L=150000u
model=pfet_01v8_hvt
spiceprefix=X
...
C {lab_pin.sym} 330 100 2 0 {name=p14 sig_type=std_logic lab=VPWR}
C {lab_pin.sym} 330 240 2 0 {name=p15 sig_type=std_logic lab=VGND}
C {lab_pin.sym} 20 320 2 0 {name=p16 sig_type=std_logic lab=VGND}
C {lab_pin.sym} 430 160 2 0 {name=p17 sig_type=std_logic lab=X}
