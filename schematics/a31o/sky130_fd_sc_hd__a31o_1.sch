...
N -80 80 -80 160 {lab=#net1}
N -80 220 -80 300 {lab=VGND}
N -80 300 -70 300 {lab=VGND}
N 40 80 40 100 {lab=#net1}
N 40 280 40 300 {lab=VGND}
...
C {sky130_fd_pr/nfet_01v8.sym} -100 190 2 1 {name=M1
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} -120 190 0 0 {name=p3 sig_type=std_logic lab=B1}
...
C {sky130_fd_pr/nfet_01v8.sym} 20 130 2 1 {name=M5
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 0 130 0 0 {name=p6 sig_type=std_logic lab=A1}
...
C {sky130_fd_pr/nfet_01v8.sym} 20 190 2 1 {name=M8
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 0 190 0 0 {name=p8 sig_type=std_logic lab=A2}
C {sky130_fd_pr/nfet_01v8.sym} 20 250 2 1 {name=M9
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 0 250 0 0 {name=p9 sig_type=std_logic lab=A3}
...
C {lab_pin.sym} 40 130 2 0 {name=p25 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 40 190 2 0 {name=p26 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 40 250 2 0 {name=p27 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -80 190 2 0 {name=p28 sig_type=std_logic lab=VNB}
