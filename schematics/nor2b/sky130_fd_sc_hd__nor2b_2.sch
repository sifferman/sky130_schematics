...
N -220 -100 -220 10 {lab=#net2}
N -220 -0 -100 -0 {lab=#net2}
N -100 -0 -100 10 {lab=#net2}
N -220 -110 -220 -100 {lab=#net2}
N -260 -70 -220 -70 {lab=#net2}
N -260 -10 -260 10 {lab=VGND}
N -260 -150 -260 -130 {lab=VPWR}
N -220 -120 -220 -110 {lab=#net2}
N -100 -120 -100 -110 {lab=#net2}
N -220 -120 -100 -120 {lab=#net2}
N -100 -120 100 -120 {lab=#net2}
N 100 -120 100 -110 {lab=#net2}
N 60 40 60 60 {lab=VGND}
N 60 -40 60 -20 {lab=Y}
...
C {ipin.sym} -160 -220 0 0 {name=p18 lab=B_N
}
C {ipin.sym} -160 -200 0 0 {name=p19 lab=VGND}
C {ipin.sym} -160 -180 0 0 {name=p20 lab=VNB}
C {ipin.sym} -160 -160 0 0 {name=p21 lab=VPB}
C {ipin.sym} -160 -140 0 0 {name=p22 lab=VPWR}
