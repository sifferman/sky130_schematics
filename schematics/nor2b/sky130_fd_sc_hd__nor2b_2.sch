...
C {ipin.sym} -430 -100 0 0 {name=p1 lab=A}
C {opin.sym} -350 -100 0 0 {name=p2 lab=Y}
...
C {ipin.sym} -430 -80 0 0 {name=p18 lab=B_N
}
C {ipin.sym} -430 -60 0 0 {name=p19 lab=VGND}
C {ipin.sym} -430 -40 0 0 {name=p20 lab=VNB}
C {ipin.sym} -430 -20 0 0 {name=p21 lab=VPB}
C {ipin.sym} -430 0 0 0 {name=p22 lab=VPWR}
