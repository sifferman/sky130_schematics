...
N -460 -120 -440 -120 {lab=D}
N -460 -380 -460 -370 {lab=VPWR}
N -460 -370 -460 -360 {lab=VPWR}
N -460 -240 -460 -220 {lab=VGND}
N -510 -330 -500 -330 {lab=C_N}
N -510 -330 -510 -270 {lab=C_N}
N -510 -270 -500 -270 {lab=C_N}
N -520 -300 -510 -300 {lab=C_N}
N -460 -300 -440 -300 {lab=D}
...
C {ipin.sym} -340 -290 0 0 {name=p14 lab=C_N}
...
C {lab_pin.sym} -440 -120 0 1 {name=p32 sig_type=std_logic lab=D}
...
C {sky130_fd_pr/pfet_01v8_hvt.sym} -480 -330 0 0 {name=M11
W=420000u
L=150000u
model=pfet_01v8_hvt
spiceprefix=X
}
C {lab_pin.sym} -520 -300 0 0 {name=p35 sig_type=std_logic lab=C_N}
C {lab_pin.sym} -460 -330 2 0 {name=p36 sig_type=std_logic lab=VPB}
C {sky130_fd_pr/nfet_01v8.sym} -480 -270 0 0 {name=M12
W=420000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} -460 -270 0 1 {name=p37 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -440 -300 0 1 {name=p38 sig_type=std_logic lab=C}
C {lab_pin.sym} -460 -220 2 0 {name=p39 sig_type=std_logic lab=VGND}
C {lab_pin.sym} -460 -380 2 0 {name=p40 sig_type=std_logic lab=VPWR}
