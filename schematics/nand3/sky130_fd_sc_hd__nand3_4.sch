...
C {lab_pin.sym} 540 -90 2 0 {name=p23 sig_type=std_logic lab=VPWR}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 140 -30 2 0 {name=12
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
...
C {lab_pin.sym} 160 -30 2 0 {name=p5 sig_type=std_logic lab=A}
...
C {sky130_fd_pr/pfet_01v8_hvt.sym} 380 -30 2 0 {name=4
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
...
C {sky130_fd_pr/pfet_01v8_hvt.sym} 260 -30 2 0 {name=16
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 400 -30 2 0 {name=p11 sig_type=std_logic lab=B}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 500 -30 2 0 {name=5
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
...
C {lab_pin.sym} 520 -30 2 0 {name=p13 sig_type=std_logic lab=B}
C {lab_pin.sym} 240 -30 0 0 {name=p14 sig_type=std_logic lab=VPB}
C {lab_pin.sym} 280 -30 2 0 {name=p15 sig_type=std_logic lab=A}
...
C {sky130_fd_pr/pfet_01v8_hvt.sym} 740 -30 2 0 {name=17
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 720 -30 0 0 {name=p34 sig_type=std_logic lab=VPB}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 620 -30 2 0 {name=7
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 760 -30 2 0 {name=p36 sig_type=std_logic lab=B}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 860 -30 2 0 {name=14
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 840 -30 0 0 {name=p37 sig_type=std_logic lab=VPB}
C {lab_pin.sym} 880 -30 2 0 {name=p38 sig_type=std_logic lab=C}
C {lab_pin.sym} 600 -30 0 0 {name=p40 sig_type=std_logic lab=VPB}
C {lab_pin.sym} 640 -30 2 0 {name=p41 sig_type=std_logic lab=B}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 1100 -30 2 0 {name=19
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 1080 -30 0 0 {name=p42 sig_type=std_logic lab=VPB}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 980 -30 2 0 {name=18
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 1120 -30 2 0 {name=p43 sig_type=std_logic lab=C}
C {sky130_fd_pr/pfet_01v8_hvt.sym} 1220 -30 2 0 {name=22
        W=1000000u
        L=150000u
        model=pfet_01v8_hvt
        spiceprefix=X
    }
C {lab_pin.sym} 1200 -30 0 0 {name=p44 sig_type=std_logic lab=VPB}
C {lab_pin.sym} 1240 -30 2 0 {name=p45 sig_type=std_logic lab=C}
C {lab_pin.sym} 960 -30 0 0 {name=p46 sig_type=std_logic lab=VPB}
C {lab_pin.sym} 1000 -30 2 0 {name=p47 sig_type=std_logic lab=C}
