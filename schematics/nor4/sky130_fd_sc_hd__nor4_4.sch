...
N -960 20 -960 30 {lab=VGND}
N -960 30 -640 30 {lab=VGND}
N -640 20 -640 30 {lab=VGND}
N -640 -50 -640 -40 {lab=Y}
N -960 -50 -640 -50 {lab=Y}
N -960 -50 -960 -40 {lab=Y}
N -840 -50 -840 -40 {lab=Y}
N -740 -50 -740 -40 {lab=Y}
N -740 20 -740 30 {lab=VGND}
N -840 20 -840 30 {lab=VGND}
N -540 -50 -540 -40 {lab=Y}
N -540 -50 -240 -50 {lab=Y}
N -240 -50 -240 -40 {lab=Y}
N -240 20 -240 30 {lab=VGND}
N -540 30 -240 30 {lab=VGND}
N -540 20 -540 30 {lab=VGND}
N -440 20 -440 30 {lab=VGND}
N -340 20 -340 30 {lab=VGND}
N -340 -50 -340 -40 {lab=Y}
N -440 -50 -440 -40 {lab=Y}
N -160 -50 -160 -40 {lab=Y}
N -160 -50 140 -50 {lab=Y}
N 140 -50 140 -40 {lab=Y}
N 140 20 140 30 {lab=VGND}
N -160 30 140 30 {lab=VGND}
...
N -60 -50 -60 -40 {lab=Y}
N 240 -50 240 -40 {lab=Y}
N 240 -50 560 -50 {lab=Y}
N 560 -50 560 -40 {lab=Y}
N 560 20 560 30 {lab=VGND}
N 240 30 560 30 {lab=VGND}
N 240 20 240 30 {lab=VGND}
N 340 20 340 30 {lab=VGND}
N 440 20 440 30 {lab=VGND}
N 440 -50 440 -40 {lab=Y}
N 340 -50 340 -40 {lab=Y}
N 390 30 390 40 {lab=VGND}
N -790 30 -790 40 {lab=VGND}
N -790 40 390 40 {lab=VGND}
N -200 40 -200 60 {lab=VGND}
N -200 -70 -200 -60 {lab=Y}
N -790 -60 -790 -50 {lab=Y}
N -790 -60 -200 -60 {lab=Y}
N -390 30 -390 40 {lab=VGND}
N -390 -60 -390 -50 {lab=Y}
N 390 -60 390 -50 {lab=Y}
N -200 -60 390 -60 {lab=Y}
N -10 30 -10 40 {lab=VGND}
N -10 -60 -10 -50 {lab=Y}
...
C {sky130_fd_pr/nfet_01v8.sym} -560 -10 2 1 {name=M2
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
...
C {ipin.sym} -560 -340 0 0 {name=p1 lab=A}
C {ipin.sym} -560 -320 0 0 {name=p18 lab=B}
C {ipin.sym} -560 -300 0 0 {name=p14 lab=C}
C {ipin.sym} -560 -280 0 0 {name=p26 lab=D}
C {ipin.sym} -560 -260 0 0 {name=p19 lab=VGND}
C {ipin.sym} -560 -240 0 0 {name=p20 lab=VNB}
C {ipin.sym} -560 -220 0 0 {name=p21 lab=VPB}
C {ipin.sym} -560 -200 0 0 {name=p22 lab=VPWR}
C {opin.sym} -520 -340 0 0 {name=p2 lab=Y}
C {lab_pin.sym} -260 -400 2 0 {name=p3 sig_type=std_logic lab=VPB}
C {lab_pin.sym} -260 -310 2 0 {name=p4 sig_type=std_logic lab=VPB}
C {lab_pin.sym} -540 -10 2 0 {name=p6 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 40 -10 0 0 {name=p7 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -300 -400 0 0 {name=p9 sig_type=std_logic lab=A}
C {lab_pin.sym} -580 -10 0 0 {name=p10 sig_type=std_logic lab=B}
C {lab_pin.sym} 80 -10 2 0 {name=p11 sig_type=std_logic lab=C}
...
C {sky130_fd_pr/nfet_01v8.sym} 160 -10 0 1 {name=M5
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 140 -10 0 0 {name=p5 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 180 -10 2 0 {name=p8 sig_type=std_logic lab=C}
...
C {lab_pin.sym} -480 -10 0 0 {name=p28 sig_type=std_logic lab=B}
...
C {sky130_fd_pr/nfet_01v8.sym} -980 -10 2 1 {name=M25
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} -960 -10 2 0 {name=p61 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -1000 -10 0 0 {name=p62 sig_type=std_logic lab=A}
C {sky130_fd_pr/nfet_01v8.sym} -860 -10 2 1 {name=M26
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} -840 -10 2 0 {name=p63 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -880 -10 0 0 {name=p64 sig_type=std_logic lab=A}
C {sky130_fd_pr/nfet_01v8.sym} -760 -10 2 1 {name=M27
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {sky130_fd_pr/nfet_01v8.sym} -660 -10 2 1 {name=M28
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} -780 -10 0 0 {name=p65 sig_type=std_logic lab=A}
C {lab_pin.sym} -680 -10 0 0 {name=p66 sig_type=std_logic lab=A}
C {lab_pin.sym} -740 -10 2 0 {name=p67 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -640 -10 2 0 {name=p68 sig_type=std_logic lab=VNB}
C {sky130_fd_pr/nfet_01v8.sym} 460 -10 0 1 {name=M29
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 440 -10 0 0 {name=p69 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 480 -10 2 0 {name=p70 sig_type=std_logic lab=D}
C {sky130_fd_pr/nfet_01v8.sym} 580 -10 0 1 {name=M30
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 560 -10 0 0 {name=p71 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 600 -10 2 0 {name=p72 sig_type=std_logic lab=D}
C {sky130_fd_pr/nfet_01v8.sym} 360 -10 0 1 {name=M31
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {sky130_fd_pr/nfet_01v8.sym} 260 -10 0 1 {name=M32
W=650000u
L=150000u
model=nfet_01v8
spiceprefix=X
}
C {lab_pin.sym} 380 -10 2 0 {name=p73 sig_type=std_logic lab=D}
C {lab_pin.sym} 280 -10 2 0 {name=p74 sig_type=std_logic lab=D}
C {lab_pin.sym} 340 -10 0 0 {name=p75 sig_type=std_logic lab=VNB}
C {lab_pin.sym} 240 -10 0 0 {name=p76 sig_type=std_logic lab=VNB}
