...
S {}
E {}
N -200 20 -200 40 {lab=VGND}
N -410 20 -360 20 {lab=VGND}
N -310 20 -260 20 {lab=VGND}
N -360 20 -310 20 {lab=VGND}
N -360 -40 -260 -40 {lab=Y}
N -460 -40 -360 -40 {lab=Y}
N -460 20 -410 20 {lab=VGND}
...
N -90 20 -40 20 {lab=VGND}
N 70 -10 80 -10 {lab=#net2}
N 10 20 60 20 {lab=VGND}
N -40 20 10 20 {lab=VGND}
N -40 -40 60 -40 {lab=Y}
N -140 -40 -40 -40 {lab=Y}
N -140 20 -90 20 {lab=VGND}
N -260 20 -140 20 {lab=VGND}
N -260 -40 -140 -40 {lab=Y}
...
C {lab_pin.sym} -200 40 2 0 {name=p16 sig_type=std_logic lab=VGND}
...
C {lab_pin.sym} 0 -10 2 0 {name=p33 sig_type=std_logic lab=B}
...
C {lab_pin.sym} -100 -10 0 1 {name=p32 sig_type=std_logic lab=A}
...
C {lab_pin.sym} -400 -10 0 0 {name=p8 sig_type=std_logic lab=B}
C {lab_pin.sym} -300 -10 0 0 {name=p11 sig_type=std_logic lab=C}
