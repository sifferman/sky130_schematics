...
<https://github.com/fossi-foundation/skywater-pdk-libs-sky130_fd_sc_hd/tree/main/cells>
...
2. **Claim a Cell**
   * Choose a cell to implement from the SKY130 PDK: [Cells List](https://github.com/fossi-foundation/skywater-pdk-libs-sky130_fd_sc_hd/tree/main/cells).
...
3. **Generate A Schematic Template**
   ...
   * Example with `or2/sky130_fd_sc_hd__or2_0`:
     * Official SPICE file to reference: [`"sky130_fd_sc_hd/cells/or2/sky130_fd_sc_hd__or2_0.spice"`](https://github.com/fossi-foundation/skywater-pdk-libs-sky130_fd_sc_hd/blob/main/cells/or2/sky130_fd_sc_hd__or2_0.spice)
